      ...
      <div className={styles.formContainer}>
        ...
        <div className={styles.form}>
          ...
          <input
            ...
            className="appearance-none bg-transparent border-gray-300 text-sm  mb-2 border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
          />
