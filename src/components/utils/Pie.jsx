...
export const PieChart = () => {
    return (
        <div className={`bg-white p-4 w-full rounded-lg shadow-md border ${styles.pie}`}>
            ...
            <div className={`${styles.ring}`}>
                <RingProgress
                    size={200}
                    sections={[{ value: 90, color: 'rgb(122, 8, 194)' }]}
                    label={
                        <Text c="rgb(122, 8, 194)" fw={900} ta="center" size="xl">
                            90
                        </Text>
                    }
                />
            ...
            <p className="text-center mt-1 text-sm">Traditional heading elements are designed to work best in the meat of your page content.</p>
